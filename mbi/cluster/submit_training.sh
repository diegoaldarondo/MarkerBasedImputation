...
#SBATCH --gres=gpu:3        # number of total gpus
#SBATCH --mem 180000        # memory for all cores
...
DATAPATH=(\
"/n/holylfs02/LABS/olveczky_lab/Diego/data/JDM31_imputation_test/JDM31_fullDay.h5" \
"/n/holylfs02/LABS/olveczky_lab/Diego/data/JDM31_imputation_test/JDM31_fullDay.h5" \
"/n/holylfs02/LABS/olveczky_lab/Diego/data/JDM31_imputation_test/JDM31_fullDay.h5" \
"/n/holylfs02/LABS/olveczky_lab/Diego/data/JDM31_imputation_test/JDM31_fullDay.h5" \
"/n/holylfs02/LABS/olveczky_lab/Diego/data/JDM31_imputation_test/JDM31_fullDay.h5" \
...
"/n/holylfs02/LABS/olveczky_lab/Diego/data/JDM31_imputation_test/JDM31_fullDay.h5")
BASEOUTPUTPATH=(\
"/n/holylfs02/LABS/olveczky_lab/Diego/data/JDM31_imputation_test/models" \
"/n/holylfs02/LABS/olveczky_lab/Diego/data/JDM31_imputation_test/models" \
"/n/holylfs02/LABS/olveczky_lab/Diego/data/JDM31_imputation_test/models" \
"/n/holylfs02/LABS/olveczky_lab/Diego/data/JDM31_imputation_test/models" \
"/n/holylfs02/LABS/olveczky_lab/Diego/data/JDM31_imputation_test/models" \
...
do
   srun -l --gres=gpu:1 -n1 -N1 --mem=60000 cluster/py.sh $FUNC ${DATAPATH[count]} --base-output-path=${BASEOUTPUTPATH[count]} --epochs=30 &
   count=$(( $count + 1 ))
done
